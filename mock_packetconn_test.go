...
//
//	mockgen -typed -package quic -self_package github.com/nxenon/h3spacex -self_package github.com/nxenon/h3spacex -destination mock_packetconn_test.go net PacketConn
//
